...
class Register:
    def __init__(self,root):
        ...
        #bg_lbl = Label(self.root, bg="white")  # Set a solid background color
        #bg_lbl.place(x=0, y=0, relwidth=1, relheight=1)

        frame1=Frame(self.root,bg="#DCDCDD")
        frame1.place(x=350,y=100,width=700,height=500)
        
        title=Label(frame1,text="REGISTER",font=("times new roman",20,"bold"),bg="#DCDCDD",fg="black").place(x=50,y=40)
        
        fname=Label(frame1,text="First Name",font=("times new roman",15,"bold"),bg="#DCDCDD",fg="black").place(x=50,y=100)
        self.txt_fname=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_fname.place(x=50,y=130,width=250)
        
        Lname=Label(frame1,text="Last Name",font=("times new roman",15,"bold"),bg="#DCDCDD",fg="black").place(x=370,y=100)
        self.txt_Lname=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_Lname.place(x=370,y=130,width=250) 
        
        contact=Label(frame1,text="Phone Number",font=("times new roman",15,"bold"),bg="#DCDCDD",fg="black").place(x=50,y=170)
        self.txt_contact=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_contact.place(x=50,y=200,width=250)
        
        email=Label(frame1,text="Email",font=("times new roman",15,"bold"),bg="#DCDCDD",fg="black").place(x=370,y=170)
        self.txt_email=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_email.place(x=370,y=200,width=250)
        
        password=Label(frame1,text="Password",font=("times new roman",15,"bold"),bg="#DCDCDD",fg="black").place(x=50,y=240)
        self.txt_password=Entry(frame1,show="*",font=("times new roman",15),bg="lightgray")
        self.txt_password.place(x=50,y=270,width=250)
        
        cpass=Label(frame1,text="Confirm password",font=("times new roman",15,"bold"),bg="#DCDCDD",fg="black").place(x=370,y=240)
        self.txt_cpass=Entry(frame1,show="*",font=("times new roman",15),bg="lightgray")
        self.txt_cpass.place(x=370,y=270,width=250)
        
        
     
        btn_register=Button(frame1,text="REGISTER NOW",font=("times new roman",15,"bold"),bg="#1985A1",fg="white",command=self.register_data).place(x=50,y=320)
